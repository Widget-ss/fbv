...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7586431237:AAGlEbYV_PQdtZlNfGkb6t157WbeEsajHRk")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002621268330"))
...
START_MSG = os.environ.get("START_MESSAGE", "Just a private Video selling bot for buying full videos bundle DM - @VerifiedSeller6969")
try:
    ADMINS=[]
...
AUTO_DELETE_MSG = os.environ.get("AUTO_DELETE_MSG", "This is DEMO videos for Buying all videos in cheap price DM - @VerifiedSeller6969\n\nये सिर्फ डेमो है, वीडियो का पैकेज खरीदने के लिए DM करे - @VerifiedSeller6969")
AUTO_DEL_SUCCESS_MSG = os.environ.get("AUTO_DEL_SUCCESS_MSG", "Video Deleted. for buying our service in cheap price. DM - @VerifiedSeller6969\n\nये सिर्फ डेमो है, वीडियो का पैकेज खरीदने के लिए DM करे - @VerifiedSeller6969")
